...
class DataInitializer(
    ...
    fun initializeData(){
        ...
        val links = mutableListOf<Link>(
            Link(name = "Github", content = "https://", isActive = true),
            Link(name = "Linkedin", content = "https://", isActive = true),
        )
        ...
        val project1 = Project(
            ...
            description = "유기묘 위치의 실시간 공유, 임시보호까지 연결해주는 서비스. 구글 맵스를 연동하여 유기묘 위치 정보를 직관적으로 " +
                    "파악할 수 있도록 하는 사용자 경험 개선 작업.",
            startYear = 2022,
            startMonth = 9,
            endYear = 2022,
            endMonth = 12,
